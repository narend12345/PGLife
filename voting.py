...
def about():
    messagebox.showinfo('About','Developed by AKASH SRIVASTAVA  and  NARENDRA PRAJAPATI')
...
home['bg'] = '#49A'
Label(home,text='COLLEGE   ELECTION',font='Helvetica 14 bold',bg='#49A').grid(row=1,column=2)
Button(home,text='CREATE NEW POLLS +',command=create).grid(row=3,column=2)
...
Label(home,text='ONLINE VOTING SYSTEM',bg='#49A').grid(row=6,column=2)
Label(home,text='Venue : SRIMT,LUCKNOW',bg='#49A').grid(row=7,column=2)
Button(home,text='About',command=about).grid(row=40,column=6)
home.mainloop()
